...
public class periodicTableExplorer {
	...
	public static void groups(int group, Console c) {
		if (group == 1) {//Alkali Metals
			...
			c.println("Description: Highly reactive metals, especially with water.");
			...
			c.println("Description: These metals are known for their electrical conductivity and use in coinage and decoration.");
			...
			c.println("Description: Colorless, odorless, and inert gases, they are chemically stable due to their full electron shells.");
		} else {
