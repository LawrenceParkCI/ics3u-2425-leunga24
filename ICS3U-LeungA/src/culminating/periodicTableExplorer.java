...
public class periodicTableExplorer {
	...
	public static void groups(int group) {
		...
		if (group >= 1 && group <= 18) {
			...
			c.println("That group number does not exist on the periodic table. There are 18 groups on the periodic table.");
		}
	}
	/**
	...
	public static void periods(int period) {
		...
		if (period >= 1 && period <= 7) {
			...
			c.println("This period does not exist on the periodic table. There are 7 periods on the periodic table.");
		}
	}
	/**
