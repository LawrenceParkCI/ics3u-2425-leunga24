...
/**
Description: This program teaches the programmer how to use for loops to display characters in a string
...
public class StringLengthAndChars {
	...
	public static void main(String[] args) {
      ...
      Ask for user input for name. Print out each individual letter of the name on separate lines, using a for loop
		...
		name1 = sc.nextLine();
		length = name1.length();
		//using for loop to display the characters in the name 
